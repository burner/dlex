...
public class LexParse : cup.lrparser.lr_parser {
	...
	protected static immutable short[][] _action_table = 
		unpackFromStrings(new string[] = [
				...
				"\007\013\xfffe\022\xfffe\023\xfffe\024\xfffe\040\xfffe\001\002" ~
				...
				"\027\xffe6\030\uffe6\031\uffe6\032\uffe6\033\uffe6\034\uffe6\045" ~
				"\uffe6\047\uffe6\050\uffe6\051\uffe6\052\uffe6\053\uffe6\054\uffe6" ~
...
class CUP_LexParse_actions {
	...
	private Vector makePreClass(int type) {
		...
		for (c = 1; c < last; c++) {
			...
			if (prev && !current) {
				result.addElement(new Interval(start, cast(char)(c-1)));
			}
		...
		if (prev && !current) result.addElement(new Interval(start, cast(char)(c-1)));
	...
	public final Symbol CUP_LexParse_do_action(int CUP_LexParse_act_num, lr_parser CUP_LexParse_parser,
			...
			switch (CUP_LexParse_act_num) {
				...
				case 74: // preclass ::= LOWERCLASS 
					{
						...
						CUP_LexParse_result = parser.getSymbolFactory().newSymbol("preclass",14, CUP_LexParse_stack.peek(), (CUP_LexParse_stack.peek()), RESULT);
					}
				...
				case 68: // classcontentelem ::= CHAR 
					{
						...
						Character c = cast(Character)(CUP_LexParse_stack.peek()).value;
						RESULT = new Interval(c.charValue(), c.charValue()); 
						CUP_LexParse_result = parser.getSymbolFactory().newSymbol("classcontentelem",10, (CUP_LexParse_stack.peek()), (CUP_LexParse_stack.peek()), RESULT);
					}
					return CUP_LexParse_result;
				...
				case 67: // classcontentelem ::= CHAR DASH CHAR 
					{
						Interval RESULT =null;
						int c1left = (CUP_LexParse_stack.elementAt(CUP_LexParse_top-2)).left;
						int c1right = (CUP_LexParse_stack.elementAt(CUP_LexParse_top-2)).right;
						Character c1 = cast(Character)( CUP_LexParse_stack.elementAt(CUP_LexParse_top-2)).value;
						int c2left = (CUP_LexParse_stack.peek()).left;
						int c2right = (CUP_LexParse_stack.peek()).right;
						Character c2 = cast(Character)( CUP_LexParse_stack.peek()).value;
						RESULT = new Interval(c1.charValue(), c2.charValue()); 
						CUP_LexParse_result = parser.getSymbolFactory().newSymbol("classcontentelem",10, (CUP_LexParse_stack.elementAt(CUP_LexParse_top-2)), (CUP_LexParse_stack.peek()), RESULT);
					}
					return CUP_LexParse_result;
				...
				case 66: // classcontent ::= MACROUSE 
					{
						...
						CUP_LexParse_result = parser.getSymbolFactory().newSymbol("classcontent",13, (CUP_LexParse_stack.peek()), (CUP_LexParse_stack.peek()), RESULT);
					}
					return CUP_LexParse_result;
				...
				case 65: // classcontent ::= classcontent MACROUSE 
					{
						...
						CUP_LexParse_result = parser.getSymbolFactory().newSymbol("classcontent",13, (CUP_LexParse_stack.elementAt(CUP_LexParse_top-1)), (CUP_LexParse_stack.peek()), RESULT);
					}
					return CUP_LexParse_result;
				...
				case 64: // classcontent ::= STRING 
					{
						Vector RESULT =null;
						int sleft = (CUP_LexParse_stack.peek()).left;
						int sright = (CUP_LexParse_stack.peek()).right;
						string s = cast(string)( CUP_LexParse_stack.peek()).value;
				...
				case 61: // classcontent ::= classcontent preclass 
					{
						...
						int listright = (CUP_LexParse_stack.elementAt(CUP_LexParse_top-1)).right;
						Vector list = cast(Vector)( CUP_LexParse_stack.elementAt(CUP_LexParse_top-1)).value;
						int plistleft = (CUP_LexParse_stack.peek()).left;
						int plistright = (CUP_LexParse_stack.peek()).right;
						Vector plist = cast(Vector)( CUP_LexParse_stack.peek()).value;
				...
				case 60: // classcontent ::= classcontentelem 
					{
						Vector RESULT =null;
						int elemleft = (CUP_LexParse_stack.peek()).left;
						int elemright = (CUP_LexParse_stack.peek()).right;
						Interval elem = cast(Interval)( CUP_LexParse_stack.peek()).value;
				...
				case 58: // charclass ::= OPENCLASS HAT DASH classcontent CLOSECLASS 
					{
						...
						CUP_LexParse_result = parser.getSymbolFactory().newSymbol("charclass",8, (CUP_LexParse_stack.elementAt(CUP_LexParse_top-4)), (CUP_LexParse_stack.peek()), RESULT);
					}
					return CUP_LexParse_result;
				...
				case 57: // charclass ::= OPENCLASS DASH classcontent CLOSECLASS 
					{
						...
						CUP_LexParse_result = parser.getSymbolFactory().newSymbol("charclass",8, (CUP_LexParse_stack.elementAt(CUP_LexParse_top-3)), (CUP_LexParse_stack.peek()), RESULT);
					}
					return CUP_LexParse_result;
				...
				case 55: // charclass ::= OPENCLASS HAT CLOSECLASS 
					{
						...
						CUP_LexParse_result = parser.getSymbolFactory().newSymbol("charclass",8, (CUP_LexParse_stack.elementAt(CUP_LexParse_top-2)), (CUP_LexParse_stack.peek()), RESULT);
					}
					return CUP_LexParse_result;
				...
				case 53: // charclass ::= OPENCLASS CLOSECLASS 
					{
						...
						CUP_LexParse_result = parser.getSymbolFactory().newSymbol("charclass",8, (CUP_LexParse_stack.elementAt(CUP_LexParse_top-1)), (CUP_LexParse_stack.peek()), RESULT);
					}
					return CUP_LexParse_result;
				...
				case 32: // hatOPT ::= 
					{
						...
						CUP_LexParse_result = parser.getSymbolFactory().newSymbol("hatOPT",16, (CUP_LexParse_stack.peek()), (CUP_LexParse_stack.peek()), RESULT);
					}
					return CUP_LexParse_result;
				...
				case 29: // states ::= IDENT 
					{
						...
						CUP_LexParse_result = parser.getSymbolFactory().newSymbol("states",11, (CUP_LexParse_stack.peek()), (CUP_LexParse_stack.peek()), RESULT);
					}
					return CUP_LexParse_result;
				...
				case 28: // states ::= IDENT COMMA states 
					{
						...
						CUP_LexParse_result = parser.getSymbolFactory().newSymbol("states",11, (CUP_LexParse_stack.elementAt(CUP_LexParse_top-2)), (CUP_LexParse_stack.peek()), RESULT);
					}
					return CUP_LexParse_result;
				...
				case 27: // statesOPT ::= 
					{
						Vector RESULT =null;
						RESULT = new Vector(); 
						CUP_LexParse_result = parser.getSymbolFactory().newSymbol("statesOPT",12, (CUP_LexParse_stack.peek()), (CUP_LexParse_stack.peek()), RESULT);
					}
					return CUP_LexParse_result;
				...
				case 20: // lookahead ::= DOLLAR 
					{
						RegExp RESULT =null;
						RESULT = makeNL(); 
						CUP_LexParse_result = parser.getSymbolFactory().newSymbol("lookahead",9, (CUP_LexParse_stack.peek()), (CUP_LexParse_stack.peek()), RESULT);
					}
					return CUP_LexParse_result;
				...
				case 13: // rules ::= LESSTHAN states MORETHAN LBRACE rules RBRACE 
					{
						...
						CUP_LexParse_result = parser.getSymbolFactory().newSymbol("rules",15, (CUP_LexParse_stack.elementAt(CUP_LexParse_top-5)), (CUP_LexParse_stack.peek()), RESULT);
					}
					return CUP_LexParse_result;
				...
				case 12: // rules ::= rules LESSTHAN states MORETHAN LBRACE rules RBRACE 
					{
						...
						CUP_LexParse_result = parser.getSymbolFactory().newSymbol("rules",15, (CUP_LexParse_stack.elementAt(CUP_LexParse_top-6)), (CUP_LexParse_stack.peek()), RESULT);
					}
					return CUP_LexParse_result;
				...
				case 8: // macro ::= UNICODE 
					{
						...
						CUP_LexParse_result = parser.getSymbolFactory().newSymbol("macro",1, (CUP_LexParse_stack.peek()), (CUP_LexParse_stack.peek()), RESULT);
					}
					return CUP_LexParse_result;
				...
				case 5: // macros ::= error 
					{
						...
						CUP_LexParse_result = parser.getSymbolFactory().newSymbol("macros",0, (CUP_LexParse_stack.peek()), (CUP_LexParse_stack.peek()), RESULT);
					}
					return CUP_LexParse_result;
				...
				case 4: // macros ::= macros macro 
					{
						...
						CUP_LexParse_result = parser.getSymbolFactory().newSymbol("macros",0, (CUP_LexParse_stack.elementAt(CUP_LexParse_top-1)), (CUP_LexParse_stack.peek()), RESULT);
					}
					return CUP_LexParse_result;
				...
				case 2: // specification ::= 
					{
						...
						CUP_LexParse_result = parser.getSymbolFactory().newSymbol("specification",3, (CUP_LexParse_stack.peek()), (CUP_LexParse_stack.peek()), RESULT);
					}
					return CUP_LexParse_result;
				...
				case 1: // specification ::= USERCODE macros DELIMITER rules 
					{
						...
						CUP_LexParse_result = parser.getSymbolFactory().newSymbol("specification",3, (CUP_LexParse_stack.elementAt(CUP_LexParse_top-3)), (CUP_LexParse_stack.peek()), RESULT);
					}
					return CUP_LexParse_result;

					/*. . . . . . . . . . . . . . . . . . . .*/
				case 0: // _START ::= specification EOF 
					{
						Object RESULT =null;
