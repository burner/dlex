 ...
 */
public final class LexScan : sym, Scanner {

  /** This character denotes the end of file */
  public static immutable int YYEOF = -1;

  /** initial size of the lookahead buffer */
  private static immutable int ZZ_BUFFERSIZE = 16384;

  /** lexical states */
  public static immutable int STRING_CONTENT = 16;
  public static immutable int REGEXPSTART = 8;
  public static immutable int MACROS = 6;
  public static immutable int STATELIST = 4;
  public static immutable int CTOR_ARG = 26;
  public static immutable int EATWSPNL = 24;
  public static immutable int CHARCLASS = 18;
  public static immutable int JAVA_CODE = 12;
  public static immutable int REGEXP = 10;
  public static immutable int YYINITIAL = 0;
  public static immutable int REPEATEXP = 22;
  public static immutable int COMMENT = 2;
  public static immutable int STATES = 14;
  public static immutable int COPY = 20;
   ...
   */
  private static immutable int ZZ_LEXSTATE[] = { 
   ...
   * Translates characters to character classes
   */
  private static immutable(char)[] ZZ_CMAP = zzUnpackCMap(ZZ_CMAP_PACKED);
  ...
  bool standalone;
  bool debugOption;
  bool useRowMap = Options.gen_method == Options.PACK || Options.gen_method == Options.TABLE;
  bool packed = Options.gen_method == Options.PACK;
  bool caseless;
  bool inclusive_states;
  bool eofclose;
  ...
  Vector!(string) ctorArgs = new Vector!(string)();
  Vector!(string) ctorTypes = new Vector!(string)();
  ...
  private bool zzRefill() {
    ...
    if(numRead == 0) {
      ...
      if(c == -1) {
        ...
        zzBuffer[zzEndRead++] = conv!(int,char)(c);
        return false;
      }     
    }
  ...
  public final void yypopStream() {
    zzReader.close();
    ZzFlexStreamInfo s = zzStreams.pop();
    zzBuffer = s.zzBuffer;
    zzReader = s.zzReader;
   ...
   */
  public final bool yymoreStreams() {
  ...
  public Symbol next_token() {
    ...
    while(true) {
      ...
      switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
        ...
        case 214: break;
        case 80: 
          { return symbol(CHAR, new Character( conv!(int,char)(
				conv!(string,int)(yytext().substring(2,yytext().length()))))); //TODO to base 16
          }
        case 215: break;
        case 140: 
        ...
        case 57: 
          { return symbol(CHAR, new Character( conv!(int,char)(
				conv!(string,int)(yytext().substring(1,yytext().length()))
					))); //TODO to base 8
          }
        case 291: break;
        case 6: 
  ...
  /** TODO fuck this runtime reflection
  ...
  public Symbol debug_next_token() {
    ...
    writeln( "line:" ~ (yyline+1) ~ " col:" ~ (yycolumn+1) ~ " --"~ yytext() 
		~ "--" ~ getTokenName(s.sym) ~ "--");
    return s;
  }
    ...
    if(argv.length == 0) {
      ...
      for(int i = 0; i < argv.length; i++) {
        ...
        try {
          ...
          writeln("File not found : \""+argv[i]+"\"");
        }
        catch (java.io.IOException e) {
          writeln("IO error scanning file \""+argv[i]+"\"");
          writeln(e);
        }
        catch (Exception e) {
